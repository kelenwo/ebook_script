...
<div bgcolor='#e4e4e4' text='#ff6633' link='#666666' vlink='#666666' alink='#ff6633'>
    <table background='' bgcolor='#e4e4e4' width='100%' class='p_tb_20' cellspacing='0' border='0' align='center' cellpadding='0'>
		<tbody>
			<tr>
				<td>
					<table width='620' border='0' align='center' cellpadding='0' cellspacing='0' bgcolor='#FFFFFF' class='bradius'>
						<tbody>
							<tr>
								<td>
<table width='620' border='0' cellspacing='0' cellpadding='0' class='bb_1'>
	<tbody>
		<tr>
			<td align='left' valign='top' class='p_rl_5'>
				<table height='146' width='100%' border='0' cellpadding='3' cellspacing='3' class='b_right'>
					<tbody>
						<tr>
							<td valign='top' class='tbl_td_css'>
							{company_info}
								<address class="mt_10">
			...
			<td align='left' valign='top' class='p_rl_5'>
				<table height='146' width='100%' border='0' cellpadding='3' cellspacing='3' >
					<tbody>
						<tr>
							<td height='16' valign='top' class='tbl_td_css2'>
                              <address>  
			...
			<td align='left' valign='top' class='p_b_5'>
				<table height='140' width='100%' border='0' cellpadding='3' cellspacing='3'>
					<tbody>
						<tr>
							<td height='10px' valign='top' class='tbl_td_css3'>
							</td>
						</tr>
						...
						<tr>
							...
							<tr>
								<td valign='top' class='tbl_td_css4'>
									<p>
							...
							<tr>
								<td class='tbl_td_css5'>
									<table width='100%' border='0' cellpadding='0' cellspacing='0' class='tbl_td_css6'>
										<tbody>
											<tr>
												<td>
<table width='570' border='0' cellspacing='0' cellpadding='0'>
	<tbody>
		<tr>
			...
			<td width='10' align='left' class='tbl_td_css7'>
				<strong><?php echo display('sl') ?></strong>
			</td>
		
			<td width='100' align='right' class='tbl_td_css7'>
				<strong><?php echo display('product_name') ?></strong>
			</td>
			<td width='60' align='right' class='tbl_td_css7'>
			...
			<td width='15'> 
				...
				<td width='10' align='left' valign='top' class='tbl_td_css8'>
				{sl}
			</td>
	
			<td width='100' align='right' valign='top' class='tbl_td_css8'>
				{product_name} - ({product_model}) {unit}
			</td>
			<td width='60' align='right' valign='top' class='tbl_td_css8'>
				{quantity}
			</td>	
			<td width='60' align='right' valign='top' class='tbl_td_css8'>
							...
							<tr align='left' >
								<td class='tbl_td_css9'>
									...
									<table width='0' border='0' align='right' cellpadding='0' cellspacing='0'>
										<tbody>
											<tr>
												<td width='0' align='left' valign='top' class='tbl_td_css10'>
													<strong><?php echo display('discount') ?></strong> 
												</td>
												<td width='100' align='right' valign='top' class='tbl_td_css11'>
											...
											<tr>
												<td align='left' valign='top' class='tbl_td_css12'>
													<strong><?php echo display('grand_total') ?>:</strong>
												</td>
												<td width='100' align='right' valign='top' class='tbl_td_css13'>
												<?php echo (($position==0)?"$currency {total_amount}":"{total_amount} $currency") ?>
												</td>
											</tr>
											
											<tr>
												<td align='left' valign='top' class='tbl_td_css12 bb_1_99'>
													<strong><?php echo display('paid_ammount') ?> :</strong>
												</td>
												<td width='100' align='right' valign='top' class='tbl_td_css13 bb_1_99'>
													<?php echo (($position==0)?"$currency {paid_amount}":"{paid_amount} $currency") ?>
												</td>
											</tr>
											<tr>
												<td align='left' valign='bottom' class='tbl_td_css14'>
													<strong><?php echo display('due') ?> :</strong>
												</td>
												<td width='100' align='right' valign='bottom' class='tbl_td_css15'>
