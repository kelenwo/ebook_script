...
<div class="form-container">
    <?php echo form_open_multipart("cdeposit/insert_deposit", array('class' => 'form-vertical', 'id' => 'insert_deposit', 'name' => 'insert_deposit')); ?>
        ...
        <div class="row-fluid">
            <div class="span3">
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" class="span10" value="<?php echo html_escape($date); ?>" id="deposit_date" name="deposit_date" required />
                    </div>
                </div>
            </div>
            <div class="span8">
